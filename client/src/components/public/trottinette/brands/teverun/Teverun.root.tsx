...
function Teverun_Root() {
    const teverunProducts: CardsTrottinetteBrand_data_Type = teverun_Data();
    
    const [search, setSearch] = useState("");

    const filtered = teverunProducts.filter((p) =>
