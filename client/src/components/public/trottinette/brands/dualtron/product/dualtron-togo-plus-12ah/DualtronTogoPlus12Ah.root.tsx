...
function DualtronTogoPlus12Ah_Root() {
    const productData: Trottinette_Data_Type = dualtronTogoPlus12Ah_Data();
    return (
        <section className={`DualtronTogoPlus12Ah_Root ${style.ContainerRootRacine}`}>
            <h1 className={style.TitleH1}>{productData.modele}</h1>
            <CarrouselProduct_Element dataImg={dualtronTogoPlus12Ah_img_Data()} />
            <br />
...
export default DualtronTogoPlus12Ah_Root;
