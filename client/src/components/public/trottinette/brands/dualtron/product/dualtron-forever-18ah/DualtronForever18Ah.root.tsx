...
function DualtronForever18Ah_Root() {
    const productData: Trottinette_Data_Type = dualtronForever18Ah_Data();
    return (
        <section className={`DualtronForever18Ah_Root ${style.ContainerRootRacine}`}>
            <h1 className={style.TitleH1}>{productData.modele}</h1>
            <CarrouselProduct_Element dataImg={dualtronForever18Ah_img_Data()} />
            <br />
...
export default DualtronForever18Ah_Root;
