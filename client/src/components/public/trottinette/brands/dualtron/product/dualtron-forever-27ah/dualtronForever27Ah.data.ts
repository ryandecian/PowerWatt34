...
function dualtronForever27Ah_Data(): Trottinette_Data_Type {
    const data: Trottinette_Data_Type = {
        marque: "Dualtron",
        modele: "Dualtron Forever",
        batterie: "60V 27Ah (LG 21700)",
        autonomie: "55 à 70 km",
        moteurs: "Bimoteurs",
...
export { dualtronForever27Ah_Data };
